...
Most of these come down to network reality or how highscalability serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

highscalability rate-limits like any public site. hsc already paces
...
Where a surface is gated, hsc reads a cookie or token you supply
...
`hsc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what hsc actually did
